...
export default function EventPostingContractModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <LtPanel shadow="lg" className="relative w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
        <div
          className="flex items-center justify-between px-6 py-4 border-b-[2px] border-[var(--lt-ink)]"
          style={{ background: 'var(--lt-sun)' }}
        >
          <div className="flex items-center gap-3">
            <FileText className="w-6 h-6" style={{ color: 'var(--lt-ink)' }} />
            <div>
              <h2 className="text-lg font-bold" style={{ color: 'var(--lt-ink)' }}>
          ...
          <button
            onClick={onClose}
            className="transition-colors p-1 rounded-lg hover:opacity-80"
        ...
        {!hasScrolledToBottom && (
          <div
            className="px-6 py-2 border-b-[2px] border-[var(--lt-ink)] text-xs text-center font-medium"
        ...
        <div
          ...
          className="flex-1 overflow-y-auto px-6 py-6 text-sm leading-relaxed space-y-4"
        ...
        >
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>1) Alcance y rol de la Plataforma</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>2) Elegibilidad, identidad y autoridad del Anunciante</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>3) Información obligatoria del Evento</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>4) Precio: reglas de transparencia</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>5) Restricciones de edad, alcohol y cumplimiento</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>6) Imágenes y propiedad intelectual</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>7) Prohibiciones (anti-fraude y seguridad)</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>8) Enlaces externos (ticketing/registro)</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>9) Moderación, revisión y derecho de retirada</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>10) Reportes y cooperación</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>11) Garantías del Anunciante</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>12) Indemnidad</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>13) Limitación de responsabilidad</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>14) Suspensión y terminación</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>15) Cambios del acuerdo</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>16) Contacto</h3>
          ...
          <div className="border-t-[2px] border-[var(--lt-ink)] my-6" />
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>1) Platform role and scope</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>2) Advertiser eligibility, identity and authority</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>3) Mandatory Event information</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>4) Price transparency</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>5) Age restrictions, alcohol and compliance</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>6) Images and intellectual property</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>7) Prohibited content and conduct</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>8) External links (ticketing/registration)</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>9) Moderation and takedown rights</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>10) Reports and cooperation</h3>
          <p>Users may report Events. You agree to cooperate in good faith with reasonable verification/correction requests.</p>

          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>11) Advertiser warranties</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>12) Indemnity</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>13) Limitation of liability</h3>
        ...
        <div
          className="border-t-[2px] border-[var(--lt-ink)] px-6 py-5 space-y-4"
        ...
        >
          <label className="flex items-start gap-3 cursor-pointer group">
            <input
              ...
              className="mt-0.5 w-5 h-5 rounded border-[var(--lt-ink)] accent-[var(--lt-terracota)] shrink-0"
            />
            <span
              className="text-sm transition-colors flex items-center gap-2"
              style={{ color: 'var(--lt-ink-soft)', fontFamily: 'var(--lt-font-sans)' }}
            >
              <ShieldCheck className="w-4 h-4 shrink-0" style={{ color: 'var(--lt-terracota)' }} />
              Acepto los{' '}
              <a
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span
              ...
              style={{ color: 'var(--lt-ink-soft)', fontFamily: 'var(--lt-font-sans)' }}
            >
              <UserCheck className="w-4 h-4 shrink-0" style={{ color: 'var(--lt-verde)' }} />
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span
              ...
              style={{ color: 'var(--lt-ink-soft)', fontFamily: 'var(--lt-font-sans)' }}
            >
              <ShieldAlert className="w-4 h-4 shrink-0" style={{ color: 'var(--lt-sun)' }} />
