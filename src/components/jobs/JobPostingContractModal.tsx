    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <LtPanel shadow="lg" className="relative w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden">
        <div
          ...
          style={{ background: 'var(--lt-terracota)' }}
        >
          <div className="flex items-center gap-3">
            <FileText className="w-6 h-6" style={{ color: 'var(--lt-paper)' }} />
            <div>
              <h2 className="text-lg font-bold" style={{ color: 'var(--lt-paper)' }}>
                Términos de Publicación de Empleos
              </h2>
              <p className="text-xs" style={{ color: 'var(--lt-paper)', opacity: 0.85 }}>
        ...
        >
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>3) Requisitos obligatorios del anuncio</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>4) Salario por hora: obligación y cumplimiento</h3>
          <p>4.1. Para publicar en la Plataforma, es obligatorio declarar un salario por hora (AUD).</p>
          <p>4.2. El Anunciante declara y garantiza que el salario por hora publicado: es real, actual y ofrecido de buena fe; y cumple como mínimo con las entitlements y mínimos legales aplicables (por ejemplo, el instrumento laboral aplicable o el salario mínimo nacional) en la jurisdicción donde se realizará el trabajo. <a href="https://www.fairwork.gov.au/" target="_blank" rel="noopener noreferrer" className="text-[var(--lt-terracota)] underline">Fair Work Ombudsman</a></p>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>5) Prohibiciones (anti-scam, legalidad y seguridad)</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>6) Enlaces externos, email y teléfono del anunciante</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>7) Moderación, revisión y derecho de retirada</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>8) Reportes y cooperación</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>9) Garantías del anunciante</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>10) Indemnidad</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>11) Limitación de responsabilidad</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>12) Suspensión y terminación</h3>
          ...
          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>13) Cambios del acuerdo</h3>
          <p>Podemos actualizar este Acuerdo. Publicaremos la versión vigente en <code className="px-1 rounded" style={{ background: 'var(--lt-bg)' }}>/job-posting-terms</code> y podremos solicitar re-aceptación al publicar o editar Anuncios.</p>

          <h3 className="font-bold pt-2" style={{ color: 'var(--lt-ink)' }}>14) Contacto</h3>
        ...
        >
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span
              ...
              style={{ color: 'var(--lt-ink-soft)', fontFamily: 'var(--lt-font-sans)' }}
            >
              <CheckCircle2 className="w-4 h-4 shrink-0" style={{ color: 'var(--lt-verde)' }} />
          ...
          <label className="flex items-start gap-3 cursor-pointer group">
            ...
            <span
              ...
              style={{ color: 'var(--lt-ink-soft)', fontFamily: 'var(--lt-font-sans)' }}
            >
              <DollarSign className="w-4 h-4 shrink-0" style={{ color: 'var(--lt-sun)' }} />
